 ...
 * @info: Struct having possible args used in
 * maintaining function prototype constants.
 * Return: given statas exit
 */
 ...
 * @info: Struct having  possible arg used maintaining
